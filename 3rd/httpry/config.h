...
#define DEFAULT_CAPFILTER ""

/* Default output format string; see doc/format-string for more information
   *** Can be overridden with -f */
#define DEFAULT_FORMAT "timestamp,type,source-ip,source-port,dest-ip,dest-port,method,host,request-uri,http-version,status-code,reason-phrase"
